...
[assembly: MelonInfo(typeof(GarlicSuperGatling.Core), "GarlicSuperGatling", "1.0.0", "Salmon", null)]
[assembly: MelonGame("LanPiaoPiao", "PlantsVsZombiesRH")]

namespace GarlicSuperGatling
{
    public class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            var ab = CustomCore.GetAssetBundle(MelonAssembly.Assembly, "garlicsupergatling");
    ...
    {
        [HarmonyPrefix]
        public static bool Prefix(ref Bullet_pea __instance, ref Zombie zombie)
        {
