...
namespace IceDoomSniperPea.BepInEx
{
    ...
    public class Core : BasePlugin//304
    {
        public override void Load()
        {
            ...
            IceDoomSniperPea.buff1 = CustomCore.RegisterCustomBuff("瞬狙：冰毁狙击的狙击间隔缩短为4秒，每次攻击有概率连狙", BuffType.AdvancedBuff, () => true, 2000, "#DA64FF", (PlantType)IceDoomSniperPea.PlantID);
            IceDoomSniperPea.buff2 = CustomCore.RegisterCustomBuff("狙狙爆：冰毁狙击每次狙击都释放一次寒冰毁灭菇效果", BuffType.AdvancedBuff, () => true, 2000, "#DA64FF", (PlantType)IceDoomSniperPea.PlantID);
            IceDoomSniperPea.buff3 = CustomCore.RegisterCustomBuff("背起了行囊：冰毁狙击每次狙击都造成21亿伤害", BuffType.AdvancedBuff, () => Lawnf.TravelAdvanced(IceDoomSniperPea.buff1) && Lawnf.TravelAdvanced(IceDoomSniperPea.buff2), 15000, "#DA64FF", (PlantType)IceDoomSniperPea.PlantID);
    ...
    public class IceDoomSniperPea : MonoBehaviour
    {
        ...
        public void AnimShoot_IceDoom()
        {
            ...
            if (plant.attackCount % 6 == 0 || Lawnf.TravelAdvanced(buff3))
            {
                damage = 2147483647;
            }
